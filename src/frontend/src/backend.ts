...
export class Backend implements backendInterface {
    ...
    async endLive(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getGroups(): Promise<Array<GroupStatus>> {
        if (this.processError) {
            try {
    ...
    async goLive(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async verifyPasscode(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
